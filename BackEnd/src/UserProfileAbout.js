                ...
                <div className="card" style={{ borderRadius: "10px" }}>
                    <div className="row">
                        <div className="col-md-4 options">
                            ...
                            <Link to="/user_about/overview" type="button" className="option_block" style={window.location.href === 'http://localhost:3000/user_about/overview' ? { backgroundColor: "#e9e8fa" } : {}}>OverView</Link>
                            <Link to="/user_about/work_and_education" type="button" className="option_block" style={window.location.href === 'http://localhost:3000/user_about/work_and_education' ? { backgroundColor: "#e9e8fa" } : {}}>Work and Education</Link>
                            <Link to="/user_about/placed_lived" type="button" className="option_block" style={window.location.href === 'http://localhost:3000/user_about/placed_lived' ? { backgroundColor: "#e9e8fa" } : {}}>Places lived</Link>
                            <Link to="/user_about/contact_and_basic_info" type="button" className="option_block" style={window.location.href === 'http://localhost:3000/user_about/contact_and_basic_info' ? { backgroundColor: "#e9e8fa" } : {}}>Contact and basic info</Link>
                            <Link to="/user_about/family_and_relationship" type="button" className="option_block" style={window.location.href === 'http://localhost:3000/user_about/family_and_relationship' ? { backgroundColor: "#e9e8fa" } : {}}>Family and relationship</Link>
                            <Link to="/user_about/user_details" type="button" className="option_block" style={window.location.href === 'http://localhost:3000/user_about/user_details' ? { backgroundColor: "#e9e8fa" } : {}}>My Details</Link>
                            <Link to="/user_about/life_event" type="button" className="option_block" style={window.location.href === 'http://localhost:3000/user_about/life_event' ? { backgroundColor: "#e9e8fa" } : {}}>Life event</Link>
                            <br /><br /><br className="br_before_768px" />
                        </div>
                        <div className="col-md-8 output mt-3">
                            <Route path="/user_about/overview">
                                <div id="overview_output">
                                    <p style={{ color: "grey" }} className="mt-4 mx-4"><i className="fa fa-briefcase" style={{ fontSize: "24px" }}></i>&ensp; Web &#38; App Specialist</p>
                                    <p style={{ color: "grey" }} className="mt-4 mx-4"><i className="fa fa-graduation-cap" style={{ fontSize: "24px" }}></i>&nbsp; K.V 1 School</p>
                                    ...
                                    <p style={{ color: "grey" }} className="mt-4 mx-4"><i className="fa fa-heart" style={{ fontSize: "24px" }}></i>&ensp; Single</p>
                                </div>
                            </Route>
                            <Route path="/user_about/work_and_education">
                                <div id="work_and_education_output">
                                    <h5 className="mx-3" style={{ color: "black" }}>Work</h5>
                                    <p style={{ color: "grey" }} className="mt-2 mx-3"><i className="fa fa-briefcase" style={{ fontSize: "24px" }}></i>&ensp; Web &#38; App Specialist</p>
                                    <h5 className="mt-4 mx-3" style={{ color: "black" }}>University</h5>
                                    <p style={{ color: "grey" }} className="mt-2 mx-3"><i className="fa fa-graduation-cap" style={{ fontSize: "24px" }}></i>&nbsp; DR. BHIMRAO AMBEDKAR UNIVERSITY, AGRA</p>
                                    <h5 className="mt-4 mx-3" style={{ color: "black" }}>High School</h5>
                                    <p style={{ color: "grey" }} className="mt-2 mx-3"><i className="fa fa-graduation-cap" style={{ fontSize: "24px" }}></i>&nbsp; K.V 1 School</p>
                                </div>
                            </Route>
                            <Route path="/user_about/placed_lived">
                            ...
                            <Route path="/user_about/contact_and_basic_info">
                                <h5 className="mx-3" style={{ color: "black" }}>Contact info</h5>
                                <p style={{ color: "grey" }} className="mt-2 mx-3"><i className="fa fa-address-card" style={{ fontSize: "24px" }}></i>&ensp; 9876543210</p>
                            ...
                            <Route path="/user_about/family_and_relationship">
                                <div id="relationship_output">
                                    <h5 className="mx-3" style={{ color: "black" }}>Relationship</h5>
                                    <p style={{ color: "grey" }} className="mt-2 mx-3"><i className="fa fa-heart" style={{ fontSize: "24px" }}></i>&ensp; Single</p>
                                    <h5 className="mt-4 mx-3" style={{ color: "black" }}>Family members</h5>
                                    <p style={{ color: "grey" }} className="mt-2 mx-3"><i className="fa fa-tree" style={{ fontSize: "24px" }}></i>&nbsp; 6 Member</p>
                                </div>
                            </Route>
                            <Route path="/user_about/user_details">
                                <div id="user_details">
                                    <h5 className="mx-3" style={{ color: "black" }}>About Akash</h5>
                            ...
                            <Route path="/user_about/life_event">
