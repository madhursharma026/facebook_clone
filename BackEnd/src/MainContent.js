...
function MainContent() {
    return (
        <div>
            <div className="card center_add_post" style={{ borderRadius: "10px" }}>
                <div className="card-body">
                    <div>
                        ...
                        <input className="user_add_post px-2" type="text" placeholder="What's on your mind, Shyam?"
                    ...
                    <div className="row">
                        <Link to="#live_btn" className="col-4 text-center live_btn py-2"><button
                            style={{ border: "none", background: "transparent" }}><i className="fa fa-video-camera" style={{ color: "red", fontSize: "20px" }}></i> <br className="br_after_1680px" /><span className="live_btn_text">Live
                                Video</span></button></Link>
                        <Link to="#photo_video_btn" className="col-4 text-center photo_video_btn py-2"><button
                            style={{ border: "none", background: "transparent" }}><i className="fa fa-picture-o" style={{ color: "#32CD32", fontSize: "20px" }}></i> <br className="br_after_1680px" /><span
                        ...
                        <Link to="#feelings_btn" className="col-4 text-center feelings_btn py-2"><button
                            style={{ border: "none", background: "transparent" }}><i className="fa fa-smile-o" style={{ color: "#BDB76B", fontSize: "20px" }}></i> <br className="br_after_1680px" /><span
            ...
            <div className="card center_post" style={{ borderRadius: "10px", marginTop: "20px" }}>
                <div className="card-body">
